		...
		try {
			...
			socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
				...
				public void call(Object... args) {
					...
					server.getPlayerManager().broadcast(Text.literal("Connected to the server"), false);
				}
			});
			...
			socket.on(Socket.EVENT_DISCONNECT, new Emitter.Listener() {
				...
				public void call(Object... args) {
					...
					server.getPlayerManager().broadcast(Text.literal("Disconnected from the server"), false);
					socket.off("magic");
				}
			});
